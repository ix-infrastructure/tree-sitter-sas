...
//! let language = tree_sitter_tree_sitter_sas::LANGUAGE;
//! parser
...
extern "C" {
    fn tree_sitter_tree_sitter_sas() -> *const ();
}

/// The tree-sitter [`LanguageFn`] for this grammar.
pub const LANGUAGE: LanguageFn = unsafe { LanguageFn::from_raw(tree_sitter_tree_sitter_sas) };
